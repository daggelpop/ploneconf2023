...
```
DEPLOY_ENV=prod
DEPLOY_HOST=ploneconf2023-daggelpop.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    ploneconf2023-daggelpop.tangrama.com.br:
      ansible_user: root
      host: ploneconf2023-daggelpop
      hostname: ploneconf2023-daggelpop.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/ploneconf2023-daggelpop.tangrama.com.br.yml` to the remote server with:
